...
<template>
  ...
  <div flex flex-col pl-5>
    <el-checkbox v-model="notificationSetting.battleWin" label="Battle end" />
    <el-checkbox v-model="notificationSetting.battleLose" label="Party wipe" />
    <el-checkbox v-model="notificationSetting.replicardEvent" label="Replicard Chest" />
    <el-checkbox v-model="notificationSetting.appearanceQuest" label="NM spawn" />
    <el-checkbox v-model="notificationSetting.itemGoal" label="Item Goal reached" />
    <el-checkbox v-model="notificationSetting.isPointOverLimit" label="Points over cap" />
    <el-checkbox v-model="notificationSetting.sampoFinish" label="Expedition completion" />
    ...
    <el-checkbox v-model="notificationSetting.actionTrigger" label="Trigger reminder" />
  </div>
  <el-alert :closable="false">
    <template #title>
      <div w-268px flex items-center justify-between gap-2>
